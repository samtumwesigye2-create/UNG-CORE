...
document.getElementById('ops').innerHTML=`Gateway: <b>${o.gateway.enabled_routes}</b> enabled / <b>${o.gateway.total_routes}</b> total routes<br>Incidents: <b>${o.incidents.open_total}</b> open · <b>${o.incidents.critical_open}</b> critical`;
