...
app.include_router(router); app.include_router(ml_router); app.include_router(ml_model_registry_router); app.include_router(ml_evaluation_router); app.include_router(ml_training_pipeline_router); app.include_router(ml_drift_router); app.include_router(ml_auto_retraining_router); app.include_router(ml_explainability_router); app.include_router(ml_prediction_router); app.include_router(ml_tuning_router); app.include_router(ml_ensemble_router); app.include_router(ml_serving_router); app.include_router(ml_health_router); app.include_router(auth_router); app.include_router(control_center_router); app.include_router(operator_router); app.include_router(gateway_router); app.include_router(routing_router); app.include_router(telemetry_router); app.include_router(alerting_router); app.include_router(audit_command_router); app.include_router(approval_router); app.include_router(scheduler_router); app.include_router(event_delivery_router); app.include_router(recovery_router); app.include_router(resource_router); app.include_router(unified_operations_router)
